...
export default function Feedbacks({ feedbacks, averageRating }: { feedbacks?: PagedResult<Feedback>, averageRating?: number }) {
                ...
                <div className="bg-white rounded-lg shadow-md border border-gray-100 p-12 text-center">
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600">Dịch vụ này chưa nhận được đánh giá từ khách hàng</p>
                        </div>
                    </div>
                </div>
            )}
